...
sam_app$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
curl -X POST  http://127.0.0.1:3000/leads -H 'Content-Type: application/json' -d '{"name":"Test", "type": "test}'